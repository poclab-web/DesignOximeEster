...
def main():
    ...
    if args.do_train:
        ...
        trainer = Trainer(dataset, model, optim, criterion, args.save_path)
        model = trainer.train(args.epochs, args.batch_size, device)
    ...
    log_dir = os.path.join(eval_save_path, 'policy_log')
    # 強化学習
