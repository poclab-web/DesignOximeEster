...
def parse_arguments():
    ...
    parser.add_argument('--reward_fns', type=str, default=['QED'], nargs='+', choices=['QED', 'Sim', 'Anti Cancer', 'LIDI', 'Docking', 'Symmetry', 'FusedRing', 'NumAromaticHeterocycles', 'MoleculeWeight', 'NumOximeActivationReward', 'MaxRingSize', 'OximePropReward', 'SmilesLength'],
