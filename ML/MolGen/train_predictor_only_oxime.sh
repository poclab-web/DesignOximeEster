...
save_path="data/results/oxime_ester_symm_oximenum_aromaticnum_hetero_maxringsize_OximePropReward_3"
tokenizer="BPE"
...
model_path="data/results/oxime_fine_tune_random/NL_model/epoch_3.pt"
