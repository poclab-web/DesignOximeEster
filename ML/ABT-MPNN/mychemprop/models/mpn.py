...
from mychemprop.features import BatchMolGraph, get_atom_fdim, get_bond_fdim, mol2graph
from mychemprop.nn_utils import index_select_ND, get_activation_function
from mychemprop.attention_visualization import visualize_atom_attention
...
class MPNEncoder(nn.Module):
    ...
    def __init__(self, args: TrainArgs, atom_fdim: int, bond_fdim: int):
        """
        :param args: A :class:`~mychemprop.args.TrainArgs` object containing model arguments.
    ...
    def forward(self,
        ...
        :param mol_graph: A :class:`~mychemprop.features.featurization.BatchMolGraph` representing
...
class MPN(nn.Module):
    ...
    def forward(self,
        ...
        :param batch: A list of list of SMILES, a list of list of RDKit molecules, or a
                      list of :class:`~mychemprop.features.featurization.BatchMolGraph`.
        ...
        if self.use_input_features:
            # print(features_batch.size()) # none type
