...
import mychemprop.data.utils
from mychemprop.data import set_cache_mol
from mychemprop.features import get_available_features_generators
...
class CommonArgs(Tap):
    ...
    def features_scaling(self) -> bool:
        """
        Whether to apply normalization with a :class:`~mychemprop.data.scaler.StandardScaler`
...
class TrainArgs(CommonArgs):
    ...
    def process_args(self) -> None:
        ...
        self.smiles_columns = mychemprop.data.utils.preprocess_smiles_columns(
            path=self.data_path,
