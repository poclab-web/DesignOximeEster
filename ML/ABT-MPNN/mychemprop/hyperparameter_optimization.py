...
from mychemprop.args import HyperoptArgs
from mychemprop.constants import HYPEROPT_LOGGER_NAME
from mychemprop.models import MoleculeModel
from mychemprop.nn_utils import param_count
from mychemprop.train import cross_validate, run_training
from mychemprop.utils import create_logger, makedirs, timeit
...
def hyperopt(args: HyperoptArgs) -> None:
    ...
    * :code:`ffn_num_layers`: The number of feed-forward layers after message passing is selected from {1, 2, 3}
    ...
    :param args: A :class:`~mychemprop.args.HyperoptArgs` object containing arguments for hyperparameter
...
def mychemprop_hyperopt() -> None:
    """Runs hyperparameter optimization for a Chemprop model.

    This is the entry point for the command line command :code:`mychemprop_hyperopt`.
    """
