...
def compute_molecule_vectors(model: nn.Module,
    ...
    """
    Computes the molecule vectors output from the last layer of a :class:`~mychemprop.models.MoleculeModel`.

    :param model: A :class:`~mychemprop.models.MoleculeModel`.
    :param data: A :class:`~mychemprop.data.MoleculeDataset`.
