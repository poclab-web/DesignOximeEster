...
def make_predictions(args: PredictArgs, smiles: List[List[str]] = None) -> List[List[Optional[float]]]:
    ...
    :param args: A :class:`~mychemprop.args.PredictArgs` object containing arguments for
...
def chemprop_predict() -> None:
    ...
    This is the entry point for the command line command :code:`mychemprop_predict`.
    """
