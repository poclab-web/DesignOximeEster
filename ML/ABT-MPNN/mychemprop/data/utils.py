...
from mychemprop.features import load_features, load_valid_atom_or_bond_features
...
def get_data_from_smiles_and_graph(smiles: List[List[str]],
                         skip_invalid_smiles: bool = True,
                         logger: Logger = None,
                         features_generator: List[str] = None,
                         coulomb_matrix: List[List[np.ndarray]] = None,
                         distance_matrix: List[List[np.ndarray]] = None,
                         adjacency_matrix: List[List[np.ndarray]] = None) -> MoleculeDataset:
    """
    Converts a list of SMILES to a :class:`~chemprop.data.MoleculeDataset`.
    ...
    data = MoleculeDataset([
        MoleculeDatapoint(
            ...
            row=OrderedDict({'smiles': smile}),
            features_generator=features_generator,
            mol_clb=coulomb_matrix[i],
            mol_adj=adjacency_matrix[i],
            mol_dist=distance_matrix[i]
