...
$PYTHON_PATH save_atom_features.py --data_path $csv_path --smiles_column $smiles_column --save_dir $save_dir --adjacency --coulomb --distance

# save rdkit feature
log_path="$log_dir/save_features.log"
save_path="$save_dir/rdkit"
$PYTHON_PATH save_features.py --data_path $csv_path --smiles_column $smiles_column --save_path $save_path --features_generator rdkit_2d_normalized