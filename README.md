...
{█(SR(m)= SS(m)  if SS(m)>0.6@SR(m)=0 ≤0.6)┤	
...
{█(FR(m)=FS(m)  if FS(m)>2 @FR(m)=0 if FS(m)≤2)┤	
...
{█(NR(m)=NS(m)  if NS(m)>2 @NR(m)=0 if NS(m)≤2)┤	
...
{█(MR(m)=MS(m)  if MS(m)=5 or 6 @MR(m)=0 if MS(m)≠5 or 6)┤	
...
OR(m)=ABTMPNN_T1 (m)[eV]+ABTMPNN_S1 (m)[eV]+ABTMPNN_S1osc (m)	
...
Method	Compound Group	Composition	Total
Filter	Ketone	Aldricha) (1293)	1293
Assembly	Oxime Ester	Aldricha) (200), Literature reviewb) (134), Virtual moleculesc) (51)	385
Generative (Pretrained)	General	Aldricha) (251,394) 	251,394
Generative (Finetuned)	Oxime Ester	After hierarchical clustering Oxime estersb,d) (64)	64
